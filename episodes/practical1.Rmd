...
## 2. Visualising images with ITK-SNAP
...
* Load the inhale scan.
    ...
    * Select the first slice from the `inhale_BH_CT` folder, which is called `1-001.dcm`. Make sure the 'File Format:' is set to 'DICOM Image Series' and click 'Next >'.
        * **Warning!** some versions of ITK-SNAP incorrectly set the 'File Format:' for the images used in this practical to '4D CTA DICOM Series'
...
### 2.3. Navigating around 3D images
...
### 2.4. Loading and displaying multiple images
...
### 2.5. Image Layer Inspector tool
