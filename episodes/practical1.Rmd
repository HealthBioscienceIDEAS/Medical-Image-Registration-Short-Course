...
* Load an additional image as a colour overlay
    ...
    * The PET scan will now be displayed in ITK-SNAP using the hot colourmap (so the lungs mostly appear in red). Depending on the version of ITK-SNAP used, the CT scan may not be visible initially - this is because the PET scan is set to full opacity.
