...
# Practical 3: Similarity measures
...
```
You have also been provided with some utility functions in *utils2.py* for use in these exercises. Some of the functions in *utils2.py* are the same as in *utils.py*, but there are some new functions.
