...
##### Windows 11
- Open the following link: http://www.itksnap.org/pmwiki/pmwiki.php
- Click on 'Downloads' on top right corner. Select 'Windows Self-Install Package (64 bit)' of itksnap 4.2.x 
- Follow the default settings of installation.
