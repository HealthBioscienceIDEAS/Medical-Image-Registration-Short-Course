...
niiX = nib.load("demo-data/CT_subject_X.nii.gz")
```
...
print(niiX.get_data_dtype())
#float32
niiX.shape
# (512, 271, 156)
niiX.affine
#array([[ -0.9765625 ,  -0.        ,  -0.        , 250.        ],
#       [ -0.        ,  -0.9765625 ,  -0.        , 136.        ],
#       [  0.        ,   0.        ,   2.5       ,  21.90002441],
#       [  0.        ,   0.        ,   0.        ,   1.        ]])
```
...
bitpix          : 32
slice_start     : 0
pixdim          : [1.        0.9765625 0.9765625 2.5       1.        1.        1.
 1.       ]
vox_offset      : 0.0
scl_slope       : nan
scl_inter       : nan
...
qoffset_y       : 0.0
qoffset_z       : 0.0
srow_x          : [ -0.9765625  -0.         -0.        250.       ]
srow_y          : [ -0.         -0.9765625  -0.        136.       ]
srow_z          : [ 0.        0.        2.5      21.900024]
intent_name     : b'                '
magic           : b'n+1'
```
