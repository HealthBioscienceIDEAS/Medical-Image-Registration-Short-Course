...
![Figure. Displayed images](fig/practical4-displayed-images.png)
...
![Figure. Difference images](fig/practical4-diff-images.png)
...
![Figure. Initialisation of the demons algorithm](fig/practical4-reg-init.png)
...
![Figure. Output of the demons algorithm](fig/practical4-defparams-output1.png)

Here is a summary of the registration:
![Figure. Output of the demons algorithm](fig/practical4-defparams-anim.gif)
...
![Figure. Output of the demons algorithm](fig/practical4-defparams-output2.png)
...
![Figure. Output of the demons algorithm](fig/practical4-elastic0-output1.png)
![Figure. Output of the demons algorithm](fig/practical4-elastic0-output2.png)

Here is a summary of the registration:
![Figure. Output of the demons algorithm](fig/practical4-elastic0-anim.gif)
...
![Figure. Output of the demons algorithm](fig/practical4-fluid0-output1.png)
![Figure. Output of the demons algorithm](fig/practical4-fluid0-output2.png)

Here is a summary of the registration:
![Figure. Output of the demons algorithm](fig/practical4-fluid0-anim.gif)
