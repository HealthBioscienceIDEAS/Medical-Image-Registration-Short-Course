...
There is a template Jupyter notebook for you to work on *practical2.ipynb*. To make sure the animations display properly, we need the figures to be displayed in a separate window and not in the notebook. Make sure you run the following cell:
```python
import matplotlib
...
## 3. Rotating images and composing transformations
