...
The `resampImageWithDefField` function uses pull-interpolation, so the image will appear to have been transformed by the inverse of the transformation in the affine matrix. We will discuss pull and push interpolations later in this lesson.
:::::::::::::::::
